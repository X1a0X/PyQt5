    ...
    def _forward_once(self, x, profile=False, visualize=False):
        ...
        for m in self.model:
            ...
            if visualize:
                ...
                feature_visualization(x, img, m.type, m.i, save_dir=visualize)
        return x
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, MixConv2d, Focus, CrossConv, BottleneckCSP,
                 CBAM, ResBlock_CBAM, Res_MSAM, ResBlock_MSAM, CoordAtt, CrossConv, C3, CTR3, C3TR, Involution, C3SPP, C3Ghost,
                 CARAFE, MSAM_CAM_INVO_CASCADE, MSAM_CAM_INVO_PARA,CoordCBAM,GAM_Attention]:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/rslab/data_tmp/zhangnan/code/yolov5-cbam/models/yolov5s_exp5.yaml', help='model.yaml')
